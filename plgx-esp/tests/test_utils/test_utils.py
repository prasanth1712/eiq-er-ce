...
from polylogyx.utils.generic import DateTimeEncoder
from polylogyx.utils.js import quote
from polylogyx.utils.mock import osquery_mock_db, validate_osquery_query
...
class TestValidate:
    ...
    def test_custom_schema(self):
        ...
        #     current_app.config["POLYLOGYX_EXTRA_SCHEMA"] = current_app.config[
