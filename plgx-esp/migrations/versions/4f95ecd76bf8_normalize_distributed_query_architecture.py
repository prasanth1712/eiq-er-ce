...
def upgrade():
    ...
    DistributedQueryTask = namedtuple(
        "DistributedQueryTask", ["id", "status", "retrieved", "guid", "node_id"]
    )

    distributed_query_task = op.create_table(
    ...
    op.add_column(
        u"distributed_query", sa.Column("description", sa.String(), nullable=True)
    )
    op.drop_constraint(
        u"distributed_query_guid_key", "distributed_query", type_="unique"
    )
    op.drop_constraint(
        u"distributed_query_node_id_fkey", "distributed_query", type_="foreignkey"
    )
    ...
    op.add_column(
        u"distributed_query_result",
        sa.Column("distributed_query_task_id", sa.Integer(), nullable=True),
    )
    ...
    op.alter_column(
        u"distributed_query_result", "distributed_query_task_id", nullable=False
    )
    op.create_foreign_key(
        None,
        "distributed_query_result",
        "distributed_query_task",
        ["distributed_query_task_id"],
        ["id"],
    )
...
def downgrade():
    ...
    op.drop_constraint(
        u"distributed_query_result_distributed_query_task_id_fkey",
        "distributed_query_result",
        type_="foreignkey",
    )
    ...
    op.drop_constraint(
        u"distributed_query_task_distributed_query_id_fkey",
        "distributed_query_task",
        type_="foreignkey",
    )
    op.drop_table(u"distributed_query")

    distributed_query = op.create_table(
        "distributed_query",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("guid", sa.String(), nullable=False),
        sa.Column("status", sa.Integer(), nullable=False),
