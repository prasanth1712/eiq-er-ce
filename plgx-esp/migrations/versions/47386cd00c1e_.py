...
def upgrade():
    ...
    op.add_column(
        "carve_session", sa.Column("completed_blocks", sa.Integer(), nullable=True)
    )
    ...
    op.add_column(
        "carve_session", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    ...
    op.alter_column(u"alerts", "rule_id", nullable=True)
...
def downgrade():
    ...
    op.add_column(
        "node", sa.Column("config_id", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "node",
        sa.Column(
            "last_results_seen_date",
            postgresql.TIMESTAMP(),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.add_column(
        "node",
        sa.Column("apply_recon", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    ...
    op.add_column(
        "carve_session",
        sa.Column(
            "blocks_received", postgresql.JSONB(), autoincrement=False, nullable=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["phish_tank_id"],
            ["phish_tank.id"],
            name="phish_tank_detections_phish_tank_id_fkey",
        ),
