...
CREATE TABLE apparmor_events (type TEXT, message TEXT, time BIGINT, uptime BIGINT, eid TEXT, apparmor TEXT, operation TEXT, parent UNSIGNED_BIGINT, profile TEXT, name TEXT, pid UNSIGNED_BIGINT, comm TEXT, denied_mask TEXT, capname TEXT, fsuid UNSIGNED_BIGINT, ouid UNSIGNED_BIGINT, capability BIGINT, requested_mask TEXT, info TEXT, error TEXT, namespace TEXT, label TEXT);
...
CREATE TABLE background_activities_moderator (path TEXT, last_execution_time BIGINT, sid TEXT);
...
CREATE TABLE chrome_extension_content_scripts (browser_type TEXT, uid BIGINT, identifier TEXT, version TEXT, script TEXT, match TEXT, profile_path TEXT, path TEXT, referenced BIGINT);
CREATE TABLE chrome_extensions (browser_type TEXT, uid BIGINT, name TEXT, profile TEXT, profile_path TEXT, identifier TEXT, version TEXT, description TEXT, default_locale TEXT, current_locale TEXT, update_url TEXT, author TEXT, persistent INTEGER, path TEXT, permissions TEXT, permissions_json TEXT, optional_permissions TEXT, optional_permissions_json TEXT, manifest_hash TEXT, referenced BIGINT, from_webstore TEXT, state TEXT, install_time TEXT, install_timestamp BIGINT, manifest_json TEXT);
...
CREATE TABLE deb_packages (name TEXT, version TEXT, source TEXT, size BIGINT, arch TEXT, revision TEXT, status TEXT, maintainer TEXT, section TEXT, priority TEXT);
ALTER TABLE deb_packages ADD pid_with_namespace INTEGER;
ALTER TABLE deb_packages ADD mount_namespace_id TEXT;
...
CREATE TABLE disk_encryption (name TEXT, uuid TEXT, encrypted INTEGER, type TEXT, encryption_status TEXT);
ALTER TABLE disk_encryption ADD uid TEXT;
ALTER TABLE disk_encryption ADD user_uuid TEXT;
ALTER TABLE disk_encryption ADD filevault_status TEXT;
...
ALTER TABLE file ADD file_version TEXT;
ALTER TABLE file ADD product_version TEXT;
ALTER TABLE file ADD bsd_flags TEXT;
ALTER TABLE file ADD pid_with_namespace INTEGER;
ALTER TABLE file ADD mount_namespace_id TEXT;
...
ALTER TABLE hash ADD pid_with_namespace INTEGER;
ALTER TABLE hash ADD mount_namespace_id TEXT;
...
CREATE TABLE logged_in_users (type TEXT, user TEXT, tty TEXT, host TEXT, time BIGINT, pid INTEGER);
...
ALTER TABLE npm_packages ADD pid_with_namespace INTEGER;
ALTER TABLE npm_packages ADD mount_namespace_id TEXT;
...
CREATE TABLE os_version (name TEXT, version TEXT, major INTEGER, minor INTEGER, patch INTEGER, build TEXT, platform TEXT, platform_like TEXT, codename TEXT, arch TEXT);
ALTER TABLE os_version ADD install_date BIGINT;
ALTER TABLE os_version ADD pid_with_namespace INTEGER;
ALTER TABLE os_version ADD mount_namespace_id TEXT;
...
ALTER TABLE process_events ADD fsuid BIGINT;
ALTER TABLE process_events ADD suid BIGINT;
ALTER TABLE process_events ADD fsgid BIGINT;
ALTER TABLE process_events ADD sgid BIGINT;
...
CREATE TABLE rpm_packages (name TEXT, version TEXT, release TEXT, source TEXT, size BIGINT, sha1 TEXT, arch TEXT, epoch INTEGER, install_time INTEGER, vendor TEXT, package_group TEXT);
ALTER TABLE rpm_packages ADD pid_with_namespace INTEGER;
ALTER TABLE rpm_packages ADD mount_namespace_id TEXT;
...
CREATE TABLE shellbags (sid TEXT, source TEXT, path TEXT, modified_time BIGINT, created_time BIGINT, accessed_time BIGINT, mft_entry BIGINT, mft_sequence INTEGER);
