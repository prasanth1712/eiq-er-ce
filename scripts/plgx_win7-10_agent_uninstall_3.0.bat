...
REM Use this script to perform EclecticIQ Agent v3.0 uninstall via 
...
REM the agent and and its path set in environment variables.
...
SET TASKXML="%TEMPDIR%\plgx_agent_uninstall_3.0.xml"
SET TASK="EclecticIQ Agent Maintenance"
SET URL="https://%IP%/downloads/windows/plgx_cpt.exe"
SET XMLURL="https://%IP%/downloads/windows/plgx_agent_uninstall_3.0.xml"
